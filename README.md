...
Passionate about Physical AI & Robotics — building toward the edge
...
| Project | Description |
| --- | --- |
| **Robot Simulation Agent AI** | In-house LLM integration · MFC polling · tool-execution pipeline design |
| **SKAB Conv-AE Anomaly Detection** | 8-channel industrial sensor data · channel-wise error decomposition (XAI) · C++/MFC integration |
| **Imitation Learning Data Efficiency** | ACT · LeRobot · SO-101 real-robot validation · demonstration count vs. success rate curves |
...
**Fine-tuning** — QLoRA · LoRA · Qwen2-7B · MIMIC-IV medical data  
**RAG** — FAISS · ChromaDB · Hybrid Search  
**Agent** — LangGraph · LangChain · Tool Calling  
**Anomaly Detection** — Conv-AE · Reconstruction Error · XAI  
...
C++/MFC application development · REST API integration · Real-time sensor data processing
